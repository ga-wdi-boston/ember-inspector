...
define("super-rentals/templates/contact", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "link-to", ["about"], ["class", "button"], 0, null, ["loc", [null, [16, 2], [18, 14]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("super-rentals/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["inline", "rental-listing", [], ["rental", ["subexpr", "@mut", [["get", "rentalUnit", ["loc", [null, [15, 36], [15, 46]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [15, 12], [15, 48]]], 0, 0]],
          locals: ["rentalUnit"],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "each", [["get", "rentals", ["loc", [null, [14, 14], [14, 21]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [14, 6], [16, 15]]]]],
        locals: ["rentals"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "list-filter", [], ["filter", ["subexpr", "action", ["filterByCity"], [], ["loc", [null, [12, 24], [12, 47]]], 0, 0]], 0, null, ["loc", [null, [12, 2], [18, 18]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("super-rentals/app")["default"].create({"name":"super-rentals","version":"0.0.0+c980731e"});
}
