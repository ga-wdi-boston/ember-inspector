define('ember-cli-mirage/serializer', ['exports', 'ember-cli-mirage/orm/model', 'ember-cli-mirage/orm/collection', 'lodash/object/assign', 'lodash/function/compose', 'ember-cli-mirage/utils/extend', 'ember-cli-mirage/utils/inflector', 'lodash/lang/isFunction'], function (exports, _emberCliMirageOrmModel, _emberCliMirageOrmCollection, _lodashObjectAssign, _lodashFunctionCompose, _emberCliMirageUtilsExtend, _emberCliMirageUtilsInflector, _lodashLangIsFunction) {
  'use strict';
  ...
  var Serializer = (function () {
    ...
    _createClass(Serializer, [{
      ...
      value: function keyForRelationship(modelName) {
        return (0, _lodashFunctionCompose['default'])(_emberCliMirageUtilsInflector.camelize, _emberCliMirageUtilsInflector.pluralize)(modelName);
      }
      ...
      value: function keyForRelationshipIds(modelName) {
        return (0, _emberCliMirageUtilsInflector.singularize)((0, _emberCliMirageUtilsInflector.camelize)(modelName)) + 'Ids';
      }
      ...
      value: function _serializeModel(model, request) {
        ...
        return (0, _lodashObjectAssign['default'])(attrs, relatedAttrs);
      }
      ...
      value: function _serializeSideloadedModelResponse(model, request) {
        ...
        this._valueForInclude(this, request).map(function (key) {
          return model[(0, _emberCliMirageUtilsInflector.camelize)(key)];
      ...
      value: function _attrsForRelationships(model, request) {
        ...
        return this._valueForInclude(this, request).reduce(function (attrs, key) {
          var modelOrCollection = model[(0, _emberCliMirageUtilsInflector.camelize)(key)];
      ...
      value: function _hasBeenSerialized(model) {
        var relationshipKey = (0, _emberCliMirageUtilsInflector.camelize)(model.modelName) + 'Ids';
      ...
      value: function _augmentAlreadySerialized(model) {
        var modelKey = (0, _emberCliMirageUtilsInflector.camelize)(model.modelName) + 'Ids';
      ...
      value: function _valueForInclude(serializer, request) {
        ...
        if ((0, _lodashLangIsFunction['default'])(include)) {
